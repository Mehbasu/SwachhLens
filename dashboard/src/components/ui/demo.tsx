...
export default function StatisticCard2({ summary }: { summary?: any }) {
    ...
    ? [
        {
          ...
          value: summary.total,
          lastMonth: summary.total > 100 ? summary.total - 80 : 0,
          prefix: '',
          suffix: '',
          format: undefined,
        ...
        },
        {
          ...
          lastMonth: summary.resolved > 80 ? summary.resolved - 50 : 0,
        },
        {
          ...stats[2],
          title: 'Avg Cleanup SLA',
          value: 3.4,
          lastMonth: 3.9,
          suffix: ' Hrs',
        },
        {
          ...
          lastMonth: summary.urgentCount + 2,
          suffix: '',
        },
      ]
    : stats;
          ...
          <Card key={index} className={`relative overflow-hidden ${stat.bg} text-white`}>
            ...
            <CardContent className="space-y-2.5 z-10 relative">
              <div className="flex items-center gap-2.5">
                ...
                <Badge className="bg-white/20 font-semibold" variant="outline">
                  {stat.delta > 0 ? <ArrowUp size={14} /> : <ArrowDown size={14} />}
                  {stat.delta}%
                </Badge>
              </div>
